...
class TailanController extends Controller
{
    ...
    public function analyse()
    {
        ...
        $t =DB::select("select d.department_name, t.department_id,d.department_type, sum(t.plan) as plan, sum(t.estimation) as estimation,  (sum(t.estimation)/sum(t.plan))*100 as percent, sum(t.estimation)-sum(t.plan) as diff from V_PROJECT t , CONST_DEPARTMENT d
