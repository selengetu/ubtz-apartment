...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $t3 =DB::select("select t.project_type, t.project_type_name_mn, (sum(t.percent)/count(t.project_id)) as niit  from V_PROJECT t
                        group by t.project_type, t.project_type_name_mn");
