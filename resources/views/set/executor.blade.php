                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-5">
                                    <button data-toggle="modal" data-target="#exampleModal" class="btn btn-primary form-control" style="padding-bottom: 10px;"><i class="fa fa-plus" style="color: rgb(255, 255, 255);">Гүйцэтгэгч нэмэх</i></button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Гүйцэтгэгч</h5>
                    ...
                    <form>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputAddress">Гүйцэтгэгчийн нэр</label>
                                <input type="text" class="form-control" id="inputAddress" placeholder="">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputAddress2">Товч нэр</label>
