                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-5">
                                    ...
                                    <button data-toggle="modal" data-target="#exampleModal" class="btn btn-primary add" style="padding-bottom: 10px;"><i class="fa fa-plus"> Ажил захиалагч нэмэх</i></button>
                                </div>
                            </div>
