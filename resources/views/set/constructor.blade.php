                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-5">
                                    <button data-toggle="modal" data-target="#exampleModal" class="btn btn-primary form-control" style="padding-bottom: 10px;"><i class="fa fa-plus" style="color: rgb(255, 255, 255);">  Ажилтан нэмэх</i></button>
                                </div>
                            </div>
                    ...
                    <form>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputAddress">Захиалагчийн нэр</label>
